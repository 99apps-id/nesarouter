          ...
          dangerouslySetInnerHTML={{
            __html: `
              try {
                ...
                if (path === '/' ) {
                  document.documentElement.dataset.theme = 'saas-landing';
                  ...
                  document.documentElement.dir = 'ltr';
                } else if (path === '/account' || path.indexOf('/account/') === 0) {
                  /* Customer portal is always light — avoid dark --ink on white inputs. */
