...
export default function ProviderDetail({
  ...
  const oauthPresetMeta = draft.oauthProfile
    ? ({
        ...
        codebuddy_cn: { device: true, label: "CodeBuddy CN" },
        codebuddy_intl: { device: false, label: "CodeBuddy Intl" },
        kilocode: { device: true, label: "Kilo" },
        kimi: { device: true, label: "Kimi" },
        qoder: { device: true, label: "Qoder" },
        qoder_cn: { device: true, label: "Qoder CN" },
        trae: { device: false, label: "Trae" },
        xiaomi_mimo: { device: false, label: "Xiaomi MiMo" },
        cline: { loopback: true },
        clinepass: { loopback: true },
        gitlab: { device: false, label: "GitLab" },
        windsurf: { device: false, label: "Windsurf" },
        zed: { device: false, label: "Zed" },
