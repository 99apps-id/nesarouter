...
export const uiChromeByLocale: Partial<Record<Exclude<LocaleCode, "en" | "id">, UiChrome>> = {
  ms: {
    ...
    aliases: {
      ...
      add: "Tambah alias",
      delete: "Padam",
      importLabel: "Import JSON NesaRouter",
      importPlaceholder: '{"aliases":{"fast":"or/meta-llama/..."}}',
      importButton: "Import JSON NesaRouter",
      importing: "Mengimport…",
      importPasteFirst: "Tampal JSON daripada NesaRouter GET /api/models/alias dahulu.",
  ...
  "zh-CN": {
    ...
    aliases: {
      ...
      add: "添加别名",
      delete: "删除",
      importLabel: "导入 NesaRouter JSON",
      importPlaceholder: '{"aliases":{"fast":"or/meta-llama/..."}}',
      importButton: "导入 NesaRouter JSON",
      importing: "正在导入…",
      importPasteFirst: "请先粘贴 NesaRouter GET /api/models/alias 的 JSON。",
  ...
  "zh-TW": {
    ...
    aliases: {
      ...
      add: "新增別名",
      delete: "刪除",
      importLabel: "匯入 NesaRouter JSON",
      importPlaceholder: '{"aliases":{"fast":"or/meta-llama/..."}}',
      importButton: "匯入 NesaRouter JSON",
      importing: "匯入中…",
      importPasteFirst: "請先貼上 NesaRouter GET /api/models/alias 的 JSON。",
  ...
  ja: {
    ...
    aliases: {
      ...
      add: "エイリアスを追加", delete: "削除", importLabel: "NesaRouter JSON をインポート", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "NesaRouter JSON をインポート", importing: "インポート中…", importPasteFirst: "先に NesaRouter GET /api/models/alias の JSON を貼り付けてください。",
  ...
  ko: {
    ...
    aliases: {
      ...
      add: "별칭 추가", delete: "삭제", importLabel: "NesaRouter JSON 가져오기", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "NesaRouter JSON 가져오기", importing: "가져오는 중…", importPasteFirst: "먼저 NesaRouter GET /api/models/alias JSON을 붙여넣으세요.",
  ...
  es: {
    ...
    aliases: {
      ...
      add: "Añadir alias", delete: "Eliminar", importLabel: "Importar JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "Importar JSON NesaRouter", importing: "Importando…", importPasteFirst: "Pegue primero el JSON de NesaRouter GET /api/models/alias.",
  ...
  fr: {
    ...
    aliases: {
      ...
      add: "Ajouter un alias", delete: "Supprimer", importLabel: "Importer JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "Importer JSON NesaRouter", importing: "Importation…", importPasteFirst: "Collez d’abord le JSON de NesaRouter GET /api/models/alias.",
  ...
  de: {
    ...
    aliases: {
      ...
      add: "Alias hinzufügen", delete: "Löschen", importLabel: "NesaRouter-JSON importieren", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "NesaRouter-JSON importieren", importing: "Importiere…", importPasteFirst: "Fügen Sie zuerst das JSON von NesaRouter GET /api/models/alias ein.",
  ...
  ar: {
    ...
    aliases: {
      ...
      add: "إضافة اسم مستعار", delete: "حذف", importLabel: "استيراد JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "استيراد JSON NesaRouter", importing: "جارٍ الاستيراد…", importPasteFirst: "الصق أولًا JSON من NesaRouter GET /api/models/alias.",
  ...
  ru: {
    ...
    aliases: {
      ...
      add: "Добавить псевдоним", delete: "Удалить", importLabel: "Импорт JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "Импорт JSON NesaRouter", importing: "Импорт…", importPasteFirst: "Сначала вставьте JSON из NesaRouter GET /api/models/alias.",
  ...
  pt: {
    ...
    aliases: {
      ...
      add: "Adicionar alias", delete: "Excluir", importLabel: "Importar JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "Importar JSON NesaRouter", importing: "Importando…", importPasteFirst: "Cole primeiro o JSON de NesaRouter GET /api/models/alias.",
  ...
  vi: {
    ...
    aliases: {
      ...
      add: "Thêm bí danh", delete: "Xóa", importLabel: "Nhập JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "Nhập JSON NesaRouter", importing: "Đang nhập…", importPasteFirst: "Dán JSON từ NesaRouter GET /api/models/alias trước.",
  ...
  it: {
    ...
    aliases: {
      ...
      add: "Aggiungi alias", delete: "Elimina", importLabel: "Importa JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "Importa JSON NesaRouter", importing: "Importazione…", importPasteFirst: "Incolla prima il JSON da NesaRouter GET /api/models/alias.",
  ...
  nl: {
    ...
    aliases: {
      ...
      add: "Alias toevoegen", delete: "Verwijderen", importLabel: "NesaRouter-JSON importeren", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "NesaRouter-JSON importeren", importing: "Importeren…", importPasteFirst: "Plak eerst JSON van NesaRouter GET /api/models/alias.",
  ...
  pl: {
    ...
    aliases: {
      ...
      add: "Dodaj alias", delete: "Usuń", importLabel: "Importuj JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "Importuj JSON NesaRouter", importing: "Importowanie…", importPasteFirst: "Najpierw wklej JSON z NesaRouter GET /api/models/alias.",
  ...
  hi: {
    ...
    aliases: {
      ...
      add: "उपनाम जोड़ें", delete: "हटाएँ", importLabel: "NesaRouter JSON आयात करें", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "NesaRouter JSON आयात करें", importing: "आयात हो रहा है…", importPasteFirst: "पहले NesaRouter GET /api/models/alias का JSON पेस्ट करें।",
  ...
  th: {
    ...
    aliases: {
      ...
      add: "เพิ่มนามแฝง", delete: "ลบ", importLabel: "นำเข้า JSON NesaRouter", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "นำเข้า JSON NesaRouter", importing: "กำลังนำเข้า…", importPasteFirst: "วาง JSON จาก NesaRouter GET /api/models/alias ก่อน",
  ...
  tr: {
    ...
    aliases: {
      ...
      add: "Takma ad ekle", delete: "Sil", importLabel: "NesaRouter JSON içe aktar", importPlaceholder: "{\"aliases\":{\"fast\":\"or/meta-llama/...\"}}",
      importButton: "NesaRouter JSON içe aktar", importing: "İçe aktarılıyor…", importPasteFirst: "Önce NesaRouter GET /api/models/alias JSON’unu yapıştırın.",
